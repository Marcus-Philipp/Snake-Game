...
const GameBoard = ({ snakeBody, food, board, score, level, isPaused, touchMove , touchIsPause, onOverlay }) => {
  ...
  return (
    <div className="flex flex-col bg-green-400 items-center lg:justify-center lg:pb-36 min-h-screen lg:bg-snack-pattern lg:bg-no-repeat lg:bg-contain lg:bg-bottom">
